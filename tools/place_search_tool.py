    ...
    def _setup_tools(self) -> List:
        ...
        def search_attractions(place:str) -> str:
            ...
            try:
                ...
                return f"Google cannot find details due to {e}. \n Following are the attractions of {place}"
        ...
        def search_transportation(place:str) -> str:
            ...
            try:
                ...
                if transportation_result:
                    return f"Following are the modes of transportation of {place} as suggested by google {transportation_result}"
            except Exception as e:
                tavily_result = self.tavily_search.tavily_search_transportation(place)
                return f"Google cannot find details due to {e}. \n Following are the modes of transporation of {place}"
